class AddBookModel {
  ...
  String? addbookPrice;
  String? addbookImage;
  final String staticImage; // Add this field for static image URL
  ...
  AddBookModel({
    ...
    this.addbookPrice,
    this.addbookImage,
    required this.staticImage, // Initialize this field in the constructor
  ...
  AddBookModel.fromJson(Map<String, dynamic> json)
      : staticImage = 'assets/images/two.PNG', // Initialize staticImage here
